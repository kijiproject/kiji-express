...
object AvroUtil {
   ...
   *
   * * Any [[java.util.Map]] will be converted to a [[scala.collection.Map]].
   * * Any [[java.util.List]] (including [[org.apache.avro.generic.GenericArray]]) will be
   *   converted to a [[scala.collection.mutable.Buffer]].
   * * Any [[org.apache.avro.generic.GenericFixed]] will be converted to an Array[Byte].
   * * Any [[org.apache.avro.generic.GenericEnumSymbol]] will be converted to its
